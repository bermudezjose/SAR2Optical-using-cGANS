...
#        self.d_sum = tf.summary.merge([self.d_sum, self.d_loss_real_sum, self.d_loss_sum])
        ...
        data = glob.glob('/mnt/Data/Pix2Pix_datasets/Semi_Exp/quemadas_ap2_case_A/train/*.npy')
        data_classifier_trn_list = glob.glob('/mnt/Data/Pix2Pix_datasets/Semi_Exp/quemadas_ap2_case_A/Classifier/training/*.npy')
        data_classifier_val_list = glob.glob('/mnt/Data/Pix2Pix_datasets/Semi_Exp/quemadas_ap2_case_A/Classifier/testing/*.npy')
        data_classifier_generator = glob.glob('/mnt/Data/Pix2Pix_datasets/Semi_Exp/quemadas_ap2_case_A/Classifier/train_test/*.npy')
...
#            sar_img_name = '10_08May_2016.npy'
            ...
            np.save(self.dataset_name + '_fake_opt_nosemi', fake_opt)
