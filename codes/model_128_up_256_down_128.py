...
#                print(batch_file)
    ...
    def generator(self, image, y=None):
        with tf.variable_scope("generator") as scope:
            ...
            # print image.shape
            e0, _, _ = deconv2d(image,
                [self.batch_size, s, s, self.input_c_dim], name='g_e0_deconv', with_w=True)
            # print e0.shape
            e1 = conv2d(lrelu(e0), self.gf_dim, name='g_e1_conv') # 64x2x5x5+64 = 3,264
            # print e1.shape
