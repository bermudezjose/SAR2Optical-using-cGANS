...
#            sample_images = np.array(sample).astype(np.float32)
        ...
        for i, sample_image in enumerate(sample_images):
            ...
            print samples.shape
            output_folder = '/home/jose/Templates/Pix2Pix/pix2pix-tensorflow_jose/datasets/sar2opt/test_fake/'
...
#                                            )
        ...
        #    mask_gans_trn = mask_gans_trn * mask
            ...
            print 'Case 03 ...'
            sar_path1 = self.sar_root_patch + '13_07Jul_2016.npy'
            sar_path2 = self.sar_root_patch + '14_31Jul_2016.npy'
            opt_path1 = self.opt_root_patch + '20160708/'
            opt_path2 = self.opt_root_patch + '20160724/'
            # La imagen opt_path1 es la imagen a reconstruir
            mask, sar1, opt_target = load_images(mask_path=None,
                                                 sar_path=sar_path1,
                                                 opt_path=opt_path1)
            _, sar2, opt_source = load_images(mask_path=None,
                                              sar_path=sar_path2,
                                              opt_path=opt_path2)
            ...
            sar2 = resampler(sar2)
            mask = resampler(mask)
            np.save(output_folder + 'opt_01_'+self.dataset_name, opt_target)
            np.save(output_folder + 'opt_02_'+self.dataset_name, opt_source)
            np.save(output_folder + 'sar_01_'+self.dataset_name, sar1)
            np.save(output_folder + 'sar_02_'+self.dataset_name, sar2)
...
#        plt.show()
    ...
    def create_dataset(self, args):
        if '11nov2015' in args.dataset_name:
            ...
            print 'creating datasetfor_' + args.dataset_name
            sar_img_name = '14_31Jul_2016.npy'
            opt_img_name = '20160724/'
            print sar_img_name, opt_img_name
        else:
...
#                             opt_path2=self.opt_root_patch + '20160724/',
#                             region=args.image_region)
#        create_dataset_case2(ksize=256,
#                             dataset=self.dataset_name,
#                             mask_path=None,
#                             sar_path1=self.sar_root_patch + '10_08May_2016.npy',
#                             sar_path2=self.sar_root_patch + '14_31Jul_2016.npy',
##                             sar_path3=self.sar_root_patch + '13_07Jul_2016.npy',
#                             opt_path1=self.opt_root_patch + '20160505/',
#                             opt_path2=self.opt_root_patch + '20160724/',
##                             opt_path3=self.opt_root_patch + '20160708/',
#                             )
        return 0